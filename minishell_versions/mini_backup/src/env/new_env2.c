...
static char	*get_first_var_key(t_infos *infos, char *str, int cursor)
{
	int		z;
	int		len_var_key;
	char	*var_key;
...
static char	*replace_one_return_code(t_infos *infos, char *str, int i,
		int heredoc)
{
	char	*second;
	char	*third;
...
static char	*manage_replace_str_one(t_infos *infos, char *str, int *cursor,
		int i)
{
	char	*var_key;
	char	*new_str;
