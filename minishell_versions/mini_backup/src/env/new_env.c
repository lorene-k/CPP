...
// Remplace une variable d'environnement $VAR par son contenu
...
// Remplace les occurences $? et $VAR dans une chaine de caractère
...
// Remplace toutes les occurences $? et $VAR dans une str (heredoc)
