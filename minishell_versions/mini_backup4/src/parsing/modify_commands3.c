...
// deplacer les blocs darguments dans le tableau (enleve les blocs NULL)
...
// Expand, enleve les quotes et supprime un argument si besoin
...
// Fait lexpansion des arguments dans la commande et supprime qd arg vide
